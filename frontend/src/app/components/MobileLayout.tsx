...
export function MobileLayout({ children }: MobileLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto bg-white shadow-2xl relative rounded-3xl overflow-hidden" style={{ height: '100vh', maxHeight: '844px' }}>
        {/* Main Content */}
        ...
        {/* Bottom Navigation */}
        <nav className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-200 pb-safe">
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-11 h-11 rounded-2xl flex items-center justify-center transition-all ${
                    ...
                    <Icon className={`w-5 h-5 ${isActive ? 'text-white' : 'text-gray-600'}`} strokeWidth={2.5} />
                  </div>
